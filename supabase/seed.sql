...
VALUES
  (gen_random_uuid(), (SELECT id FROM t_basic), 'modern_v1', 'Modern Elegance', 'modern-elegance', 'https://images.unsplash.com/photo-1519741497674-611481863552?w=500&q=80', 'modern', true),
  (gen_random_uuid(), (SELECT id FROM t_basic), 'classic_v1', 'Classic Romance', 'classic-romance', 'https://images.unsplash.com/photo-1511285560929-80b456fea0bc?w=500&q=80', 'floral', true),
  (gen_random_uuid(), (SELECT id FROM t_prem), 'java_v1', 'Javanese Heritage', 'javanese-heritage', 'https://images.unsplash.com/photo-1544923405-b3eafc1122ce?w=500&q=80', 'traditional', true),
